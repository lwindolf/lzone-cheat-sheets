...
<br/><b>Solutions</b> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/SaaS Dev Tools'>SaaS Dev Tools</a> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/Service Architecture'>Service Architecture</a> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/Solutions Automation'>Solutions Automation</a> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/Solutions Loadbalancing'>Solutions Loadbalancing</a> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/Solutions Monitoring'>Solutions Monitoring</a> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/Solutions NoSQL'>Solutions NoSQL</a> | <a href='https://lzone.de/#/LZone Cheat Sheets/Solutions/Solutions Virtualization'>Solutions Virtualization</a>
...
- [30s-of-code CSS](https://github.com/LZone 30-seconds/30-seconds-of-css)
- [30s-of-code Git](https://github.com/LZone 30-seconds/30-seconds-of-git)
- [30s-of-code JS](https://github.com/LZone 30-seconds/30-seconds-of-code)
- [30s-of-code Python](https://github.com/LZone 30-seconds/30-seconds-of-python)
- [AWS EKS Workshop](https://github.com/LZone aws-samples/eks-workshop-v2)
- [AWS S3 Python](https://github.com/LZone nagwww/aws-s3-book)
- [AWS Serverless Workshop](https://github.com/LZone aws-samples/aws-serverless-workshops)
- [AWSCookbook Security](https://github.com/LZone AWSCookbook/Security)
- [Ansible Tutorial](https://github.com/LZone leucos/ansible-tuto)
- [Architecture Books](https://github.com/LZone mhadidg/software-architecture-books)
- [Architecture Domain Driven Hexagon](https://github.com/LZone Sairyss/domain-driven-hexagon)
- [Architecture Enterprise Patterns](https://github.com/LZone chanakaudaya/solution-architecture-patterns)
- [Architecture Microservices](https://github.com/LZone rodrigorodrigues/microservices-design-patterns)
- [Awesome AWS Security](https://github.com/LZone jassics/awesome-aws-security)
- [Awesome Azure Architecture](https://github.com/LZone lukemurraynz/awesome-azure-architecture)
- [Awesome CS Courses](https://github.com/LZone prakhar1989/awesome-courses)
- [Awesome Cheat Sheets](https://github.com/LZone detailyang/awesome-cheatsheet)
- [Awesome Cloud Security](https://github.com/LZone 4ndersonLin/awesome-cloud-security)
- [Awesome Design Patterns](https://github.com/LZone DovAmir/awesome-design-patterns)
- [Awesome GraphQL](https://github.com/LZone chentsulin/awesome-graphql)
- [Awesome OSINT](https://github.com/LZone jivoi/awesome-osint)
- [Awesome OpenPolicyAgent](https://github.com/LZone StyraInc/awesome-opa)
- [Awesome Programming Projects](https://github.com/LZone practical-tutorials/project-based-learning)
- [Awesome Public Datasets](https://github.com/LZone awesomedata/awesome-public-datasets)
- [Awesome Python](https://github.com/LZone vinta/awesome-python)
- [Awesome Scalability](https://github.com/LZone binhnguyennus/awesome-scalability)
- [Awesome Security](https://github.com/LZone zbetcheckin/Security_list)
- [Awesome k8s Security](https://github.com/LZone magnologan/awesome-k8s-security)
- [Azure Powershell](https://github.com/LZone andreipintica/Azure-PowerShell-CheatSheet)
- [Backend Development Whitepaper](https://github.com/LZone cheatsnake/backend-cheats)
- [Bash Handbook](https://github.com/LZone denysdovhan/bash-handbook)
- [Bash Streams Handbook](https://github.com/LZone miguelmota/bash-streams-handbook)
- [Bash by Example](https://github.com/LZone cheatsnake/bash-scripts-by-example)
- [Bayesian Modelling in Python](https://github.com/LZone markdregan/Bayesian-Modelling-in-Python)
- [C4-PlantUML Documentation](https://github.com/LZone plantuml-stdlib/C4-PlantUML)
- [CSS Architecture](https://github.com/LZone jareware/css-architecture)
- [Cloud Outages Index](https://github.com/LZone lwindolf/cloud-outages)
- [Cloud Provider Cheat Sheets](https://github.com/LZone JeffDeCola/my-cheat-sheets)
- [Coding Interview University](https://github.com/LZone jwasham/coding-interview-university)
- [DDD Context Mapping](https://github.com/LZone ddd-crew/context-mapping)
- [DDD Miro Templates](https://github.com/LZone ddd-crew/virtual-modelling-templates)
- [DDD Starter Modelling](https://github.com/LZone ddd-crew/ddd-starter-modelling-process)
- [DDD by Examples](https://github.com/LZone ddd-by-examples/library)
- [Databases Introduction](https://github.com/LZone anhthii/database-notes)
- [Design: Aggregate Design Canvas](https://github.com/LZone ddd-crew/aggregate-design-canvas)
- [Design: Bounded Context Canvas](https://github.com/LZone ddd-crew/bounded-context-canvas)
- [Design: Core Domain Charts](https://github.com/LZone core-domain-charts)
- [DevOps Cheat Sheet](https://github.com/LZone anshudutta/DevOps-cheat-sheet)
- [DevOps Video Tutorials](https://github.com/LZone antonputra/tutorials)
- [DevSecOps Maturity Model](https://github.com/LZone devsecopsmaturitymodel/DevSecOps-MaturityModel)
- [DevSecOps SLSA Framework](https://github.com/LZone slsa-framework/slsa)
- [Docker Cheat Sheet](https://github.com/LZone wsargent/docker-cheat-sheet)
- [Docker Getting Started](https://github.com/LZone docker/getting-started)
- [Documentation Apache CloudStack](https://github.com/LZone apache/cloudstack-docs)
- [Documentation ArgoCD](https://github.com/LZone argoproj/argo-cd)
- [Documentation Cacti](https://github.com/LZone Cacti/documentation)
- [Documentation Certbot](https://github.com/LZone certbot/certbot)
- [Documentation Chef](https://github.com/LZone chef/chef-web-docs)
- [Documentation CircleCI](https://github.com/LZone circleci/circleci-docs)
- [Documentation CloudFoundry Bosh](https://github.com/LZone cloudfoundry/docs-bosh)
- [Documentation Compendium](https://github.com/LZone kylelobo/The-Documentation-Compendium)
- [Documentation CoreDNS](https://github.com/LZone coredns/coredns.io)
- [Documentation Datadog](https://github.com/LZone DataDog/documentation)
- [Documentation Docker](https://github.com/LZone docker/docs)
- [Documentation FluentBit](https://github.com/LZone fluent/fluent-bit-docs)
- [Documentation Flux](https://github.com/LZone fluxcd/website)
- [Documentation FreeBSD](https://github.com/LZone freebsd/freebsd-doc)
- [Documentation GRR](https://github.com/LZone google/grr-doc)
- [Documentation Google GVisor](https://github.com/LZone google/gvisor)
- [Documentation Google OSFIR](https://github.com/LZone google/osdfir-infrastructure)
- [Documentation Grafana Loki](https://github.com/LZone grafana/loki)
- [Documentation Grafana LokiStack Operator](https://github.com/LZone grafana/loki)
- [Documentation Helm](https://github.com/LZone helm/helm-www)
- [Documentation Kata Containers](https://github.com/LZone kata-containers/kata-containers)
- [Documentation Linode](https://github.com/LZone linode/docs)
- [Documentation OSV Scanner](https://github.com/LZone google/osv-scanner)
- [Documentation OpenTelemetry](https://github.com/LZone open-telemetry/opentelemetry.io)
- [Documentation Openshift](https://github.com/LZone openshift/openshift-docs)
- [Documentation Powershell](https://github.com/LZone MicrosoftDocs/PowerShell-Docs)
- [Documentation Prometheus](https://github.com/LZone prometheus/docs)
- [Documentation Prometheus Alertmanager](https://github.com/LZone prometheus/alertmanager)
- [Documentation Prometheus Operator](https://github.com/LZone prometheus-operator/prometheus-operator)
- [Documentation Puppet](https://github.com/LZone puppetlabs/puppet-docs)
- [Documentation RabbitMQ](https://github.com/LZone rabbitmq/rabbitmq-website)
- [Documentation RedisLabs](https://github.com/LZone RedisLabs/redislabs-docs)
- [Documentation Telegraf](https://github.com/LZone influxdata/telegraf)
- [Documentation TravisCI](https://github.com/LZone travis-ci/docs-travis-ci-com)
- [Documentation cfengine](https://github.com/LZone cfengine/documentation)
- [Documentation docker-bench-security](https://github.com/LZone docker/docker-bench-security)
- [Documentation juju](https://github.com/LZone juju/juju)
- [Documentation knative](https://github.com/LZone knative/docs)
- [Documentation kubebench](https://github.com/LZone aquasecurity/kube-bench)
- [Documentation kubernetes](https://github.com/LZone kubernetes/website)
- [Documentation pfsense (legacy)](https://github.com/LZone pfsense/docs)
- [Documentation pprof](https://github.com/LZone google/pprof)
- [Documentation rundeck](https://github.com/LZone rundeck/docs)
- [Elastic Data Lake Architecture](https://github.com/LZone gose/elastic-data-lake)
- [ElasticSearch Architecture](https://github.com/LZone gose/elastic-architectures)
- [ElasticSearch Examples](https://github.com/LZone elastic/examples)
- [Excel Cheat Sheet](https://github.com/LZone emanuelefavero/excel)
- [FastAI Fastbook](https://github.com/LZone fastai/fastbook)
- [Favicon Cheat Sheet](https://github.com/LZone audreyfeldroy/favicon-cheat-sheet)
- [Free Programming Books](https://github.com/LZone EbookFoundation/free-programming-books)
- [Free Tier SaaS List](https://github.com/LZone ripienaar/free-for-dev)
- [Fuzzing 101](https://github.com/LZone antonio-morales/Fuzzing101)
- [GCP Cheat Sheet](https://github.com/LZone dennyzhang/cheatsheet-gcp-A4)
- [GDB Cheat Sheet](https://github.com/LZone reveng007/GDB-Cheat-Sheet)
- [Geo Data Science Book](https://github.com/LZone gdsbook/book)
- [Github Cheat Sheet](https://github.com/LZone tiimgreen/github-cheat-sheet)
- [Globbing Cheat Sheet](https://github.com/LZone begin/globbing)
- [Google Cloud Guide](https://github.com/LZone mikeroyal/Google-Cloud-Guide)
- [Google DevOps Governance](https://github.com/LZone google/devops-governance)
- [Google Engineering Practices](https://github.com/LZone google/eng-practices)
- [How Programming Works](https://github.com/LZone HowProgrammingWorks/Book)
- [IMDB Data in the Terminal](https://github.com/LZone vvijayan1/imdb_data_on_terminal)
- [Interview Questions: 30s-of-code JS](https://github.com/LZone 30-seconds/30-seconds-of-interviews)
- [Interview Questions: Android](https://github.com/LZone amitshekhariitbhu/android-interview-questions)
- [Interview Questions: Data Science](https://github.com/LZone alexeygrigorev/data-science-interviews)
- [Interview Questions: FAANG](https://github.com/LZone ombharatiya/FAANG-Coding-Interview-Questions)
- [Interview Questions: Java](https://github.com/LZone in28minutes/interview-guide)
- [Interview Questions: Linux Sysadmin](https://github.com/LZone chassing/linux-sysadmin-interview-questions)
- [Interview Questions: ML](https://github.com/LZone Sroy20/machine-learning-interview-questions)
- [Interview Questions: System Design](https://github.com/LZone shashank88/system_design)
- [Interview Questions: System Design and Architecture](https://github.com/LZone puncsky/system-design-and-architecture)
- [JS Promise Cookbook](https://github.com/LZone mattdesl/promise-cookbook)
- [Jaeger Distributed Tracing](https://github.com/LZone jaegertracing/documentation)
- [Java 8 Tutorial](https://github.com/LZone winterbe/java8-tutorial)
- [Javascript ES6 Cheatsheet](https://github.com/LZone DrkSephy/es6-cheatsheet)
- [Javascript Functional Programming](https://github.com/LZone MostlyAdequate/mostly-adequate-guide)
- [Javascript NPM with ES Modules](https://github.com/LZone transitive-bullshit/npm-es-modules)
- [Kafka Architecture](https://github.com/LZone anhthii/kafka-notes)
- [Learn Regex](https://github.com/LZone ziishaned/learn-regex)
- [Learn To Cloud](https://github.com/LZone learntocloud/learn-to-cloud)
- [Learn UML2](https://github.com/LZone imalitavakoli/learn-uml2)
- [Learn Vim](https://github.com/LZone iggredible/Learn-Vim)
- [LearnXinYMinutes](https://github.com/LZone adambard/learnxinyminutes-docs)
- [Learning Path AI Expert](https://github.com/LZone AMAI-GmbH/AI-Expert-Roadmap)
- [Learning Path Data Science](https://github.com/LZone myarist/Data-Science-Learning-Path)
- [Learning Path FullStack Web Dev](https://github.com/LZone shovanch/fullstack-web-developer-path)
- [Learning Path Functional Programming](https://github.com/LZone imteekay/functional-programming-learning-path)
- [Learning Path Senior Developer](https://github.com/LZone joebew42/study-path)
- [Learning Path Springboot Microservices](https://github.com/LZone TechPrimers/learning-path-spring-boot-microservices)
- [Learning Path System Design](https://github.com/LZone TechPrimers/learning-path-system-design)
- [Learning Path Thinkerhub](https://github.com/LZone tinkerhub/TinkerHub-Learning-Paths)
- [Learning Path by Role](https://github.com/LZone belatrix/learningPaths)
- [Learning Path k8s](https://github.com/LZone techiescamp/kubernetes-learning-path)
- [Learning Path k8s (Microsoft)](https://github.com/LZone microsoft/kubernetes-learning-path)
- [Learning freeCodeCamp](https://github.com/LZone freeCodeCamp/freeCodeCamp)
- [Linux XDP Tutorial](https://github.com/LZone xdp-project/xdp-tutorial)
- [Little Go Book](https://github.com/LZone karlseguin/the-little-go-book)
- [Little MongoDB Book](https://github.com/LZone karlseguin/the-little-mongodb-book)
- [Little Redis Book](https://github.com/LZone karlseguin/the-little-redis-book)
- [MDN accessibility](https://github.com/LZone mdn/content)
- [MDN api](https://github.com/LZone mdn/content)
- [MDN css](https://github.com/LZone mdn/content)
- [MDN demos](https://github.com/LZone mdn/content)
- [MDN events](https://github.com/LZone mdn/content)
- [MDN exslt](https://github.com/LZone mdn/content)
- [MDN guide](https://github.com/LZone mdn/content)
- [MDN html](https://github.com/LZone mdn/content)
- [MDN http](https://github.com/LZone mdn/content)
- [MDN javascript](https://github.com/LZone mdn/content)
- [MDN manifest](https://github.com/LZone mdn/content)
- [MDN mathml](https://github.com/LZone mdn/content)
- [MDN media](https://github.com/LZone mdn/content)
- [MDN opensearch](https://github.com/LZone mdn/content)
- [MDN performance](https://github.com/LZone mdn/content)
- [MDN privacy](https://github.com/LZone mdn/content)
- [MDN progressive_web_apps](https://github.com/LZone mdn/content)
- [MDN security](https://github.com/LZone mdn/content)
- [MDN svg](https://github.com/LZone mdn/content)
- [MDN text_fragments](https://github.com/LZone mdn/content)
- [MDN tutorials](https://github.com/LZone mdn/content)
- [MDN webdriver](https://github.com/LZone mdn/content)
- [MDN xml](https://github.com/LZone mdn/content)
- [MDN xpath](https://github.com/LZone mdn/content)
- [MDN xslt](https://github.com/LZone mdn/content)
- [MITM Cheat Sheet](https://github.com/LZone frostbits-security/MITM-cheatsheet)
- [MS Architecture Center](https://github.com/LZone MicrosoftDocs/architecture-center)
- [MS Azure Security](https://github.com/LZone MicrosoftDocs/security)
- [MS Virtualization](https://github.com/LZone MicrosoftDocs/Virtualization-Documentation)
- [Markdown Architecture Decision Records](https://github.com/LZone adr/madr)
- [Meta Checklist](https://github.com/LZone huyingjie/Checklist-Checklist)
- [Modern C++ Tutorial](https://github.com/LZone changkun/modern-cpp-tutorial)
- [Naming Cheat Sheet](https://github.com/LZone kettanaito/naming-cheatsheet)
- [Nature of Code](https://github.com/LZone nature-of-code/noc-book-2023)
- [Network Segmentation Cheat Sheet](https://github.com/LZone sergiomarotco/Network-segmentation-cheat-sheet)
- [OS Tutorial](https://github.com/LZone cfenollosa/os-tutorial)
- [OSS Vulnerability Guide](https://github.com/LZone google/oss-vulnerability-guide)
- [OWASP Cheat Sheets Series](https://github.com/LZone OWASP/CheatSheetSeries)
- [OpenSSL Architecture](https://github.com/LZone openssl/web)
- [Puppet Handbook](https://github.com/LZone abhishekjt/puppet-handbook)
- [Pure Bash Bible](https://github.com/LZone dylanaraps/pure-bash-bible)
- [Python Introcution: Byte of Python](https://github.com/LZone swaroopch/byte-of-python)
- [Python Machine Learning](https://github.com/LZone rasbt/python-machine-learning-book-3rd-edition)
- [Python Tutorial](https://github.com/LZone Akuli/python-tutorial)
- [Python pdb Tutorial](https://github.com/LZone spiside/pdb-tutorial)
- [RabbitMQ Client Tutorials](https://github.com/LZone rabbitmq/rabbitmq-tutorials)
- [Reverse Shells](https://github.com/LZone d4t4s3c/Offensive-Reverse-Shell-Cheat-Sheet)
- [Runbooks AWS Incidents](https://github.com/LZone aws-samples/aws-incident-response-playbooks)
- [Runbooks Concept](https://github.com/LZone iworkforthem/runbook)
- [Runbooks Container Solutions](https://github.com/LZone ContainerSolutions/runbooks)
- [Runbooks Example](https://github.com/LZone sstafford/ops_runbook)
- [Runbooks Openshift](https://github.com/LZone openshift/runbooks)
- [Runbooks PagerDuty Incident Response](https://github.com/LZone PagerDuty/incident-response-doc)
- [Runbooks Pentesting](https://github.com/LZone IlyasKadi/runbook)
- [Runbooks Prometheus Operator](https://github.com/LZone prometheus-operator/runbooks)
- [Runbooks Security Incident](https://github.com/LZone redar0n/incident-runbook)
- [SAP Tutorials](https://github.com/LZone sap-tutorials/Tutorials)
- [Scalable SW Architecture](https://github.com/LZone Developer-Y/Scalable-Software-Architecture)
- [Security 101 for SaaS Startups](https://github.com/LZone forter/security-101-for-saas-startups)
- [SysML v2 Documentation](https://github.com/LZone Systems-Modeling/SysML-v2-Release)
- [System Design 101](https://github.com/LZone ByteByteGoHq/system-design-101)
- [System Design Primer](https://github.com/LZone donnemartin/system-design-primer)
- [Tekton 101](https://github.com/LZone dewan-ahmed/Tekton101)
- [The JS Way](https://github.com/LZone thejsway/thejsway)
- [Typescript Handbook](https://github.com/LZone microsoft/TypeScript-Website)
- [WTFJS](https://github.com/LZone denysdovhan/wtfjs)
- [Xapax Security](https://github.com/LZone xapax/security)
- [devhints.io](https://github.com/LZone rstacruz/cheatsheets)
- [eg Cheat Sheets](https://github.com/LZone srsudar/eg)
- [golang Cheat Sheet](https://github.com/LZone a8m/golang-cheat-sheet)
- [k8s CKAD Tutorial](https://github.com/LZone madhank93/learn-k8s-ckad)
- [k8s Istio Tutorial](https://github.com/LZone kelseyhightower/istio-ingress-tutorial)
- [k8s NetworkPolicy Tutorial](https://github.com/LZone networkpolicy/tutorial)
- [k8s Nomand Tutorial](https://github.com/LZone kelseyhightower/nomad-on-kubernetes)
- [k8s Tekton Tutorial](https://github.com/LZone harbur/tekton-tutorial)
